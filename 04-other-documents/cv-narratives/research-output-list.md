...
**Contribution statements matter more than author position.** Conventions differ across fields
and panels cannot infer your role. Each entry below states it explicitly, in one line.
...
*Journal of Medical Internet Research* 2023;25:e39736.
> *Contribution:* First author. Conceived the tool, designed and implemented the NLP,
> dimensionality-reduction and clustering pipeline, conducted the performance evaluation, wrote
> the manuscript. Now used by other groups, including in the systematic review at item 5.
...
> *Contribution:* First author. Designed the analysis, implemented the gradient-boosted models,
> conducted the cross-country transportability assessment, wrote the manuscript.

**4. Orel E**, Sobel J, Zanella MC, Iten A, Kaiser L, Keiser O, Vetter P.
Difference in clinical severity between Delta variant and Omicron sub-lineages in a Swiss
tertiary center. *CMI Communications* 2024.
...
Legionellosis in Geneva: modelling of risk factors, geospatial and temporal analysis, and
...
- **Item 2 (the platform) occupies a slot that could hold a peer-reviewed paper.** I think it
  earns its place: it is the instrument the whole proposal rests on, it is unambiguously yours,
