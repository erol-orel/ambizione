# Applicant facts incorporated, and what is still open

## Incorporated (this round)
...
> Ambizione would be the first position in which my full research time is dedicated to a
> scientific programme for which I am the principal investigator and scientific lead.
...
- `[[Erol Orel, XX%]]` → **100%**. This is now an asset rather than a gap: current time is split
  across MAS, GESICA, legionellosis and GeoAI4EI; Ambizione consolidates it into one PI-led
...
| Episode | Onset | End | Outcome series available | Pre-onset history | External evidence at origin | Eligible? |

separately for respiratory and heat, applying the six T3.0 eligibility criteria. Only then fix
**N**, the archetype horizons and **Δ**, and run the design simulation. Until that count exists,
`[[expected order of ten]]` in T3.3 stays a placeholder and must not be written as a fact.
